...
public class InterestController {
	...
	@DeleteMapping
	public ResponseEntity<String> delete(@RequestBody @ApiParam(value = "관심 아파트 정보(userid, aptcode)", required = true) Map<String,Object> map) throws Exception {
	...
	public ResponseEntity<List<InterestDto>> list(
			@RequestBody @ApiParam(value = "관심 아파트 정보(userid)", required = true) Map<String,Object> map) throws Exception {
