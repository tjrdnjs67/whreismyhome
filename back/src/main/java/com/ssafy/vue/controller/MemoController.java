...
public class MemoController {
	...
	@PostMapping
	public ResponseEntity<String> regist(@RequestBody @ApiParam(value = "게시글 정보. (userid, articletype, comment, articleno)", required = true) MemoDto memoDto) throws Exception {
	...
	@GetMapping
	public ResponseEntity<List<MemoDto>> list(@ApiParam(value = "댓글을 얻기위한 부가정보. (articleno, articletype, pg, spp)", required = true) MemoParameterDto memoParameterDto) throws Exception {
		System.out.println(memoParameterDto.toString());
		logger.info("list - 호출");
	...
	@GetMapping("/nav")
	public ResponseEntity<String> navigation(@ApiParam(value = "네비게이션을 얻기위한 부가정보. (articleno, articletype, pg, spp)", required = true)  MemoParameterDto memoParameterDto) throws Exception {
	...
	@PutMapping
	public ResponseEntity<String> edit(@ApiParam(value = "댓글 수정을 위한 부가정보. (comment, memono)", required = true) MemoDto memoDto) throws Exception {
		logger.info("edit - 호출");
	...
	@DeleteMapping
	public ResponseEntity<String> delete(@ApiParam(value = "댓글 삭제를 위한 부가정보.(memono)", required = true) int memono) throws Exception {
