...
@ApiModel(value = "InterestDto : 관심아파트정보", description = "관심아파트의 상세 정보를 나타낸다.")
public class InterestDto {
	...
	public String toString() {
		return "InterestDto [userid=" + userid + ", aptCode=" + aptCode + ", aptName="
				+ aptName + ", dongCode=" + dongCode + ", dongName=" + dongName + ", sidoName=" + sidoName
				+ ", gugunName=" + gugunName + ", buildYear=" + buildYear + ", jibun=" + jibun + ", lat=" + lat
				+ ", lng=" + lng + ", img=" + img + ", recentPrice=" + recentPrice + "]";
	}
}
